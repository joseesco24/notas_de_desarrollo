...
- **Son seguras:** Los contenedores acceden solo a los recursos a los que deben acceder, jamás acceden a secciones importantes del sistema operativo de la máquina anfitrión, a no ser que se configuren estas funcionalidades.

Docker como gestor de contenedores se divide en tres capas, con las que es necesario interactuar de cierta forma para para acceder a todas sus funcionalidades para poder sacarle provecho, las cuales son:
